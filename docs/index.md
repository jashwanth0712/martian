...
## Controls
- [Burst Controls](burst-controls.md) — 500ms burst control system (ASDF/ZX keys), countdown UI, and key mapping details.
...
- [Lava Surface](lava-surface.md) — Lava color system, glow effects, sparkles, and design decisions.
